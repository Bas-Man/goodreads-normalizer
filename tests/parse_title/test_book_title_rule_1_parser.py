...
TEST_TITLES = [
    (
        "All The Skills 5 (All The Skills #5)",
        "All The Skills 5",
        [Series(name="All The Skills", numbers=["5"])],
    ),
    (
        "A Better World (Brilliance Saga, #2)",
        "A Better World",
        [Series(name="Brilliance Saga", numbers=["2"])],
    ),
    (
        "Not a Drill (Jack Reacher, #18.5)",
        "Not a Drill",
        [Series(name="Jack Reacher", numbers=["18.5"])],
    ),
    (
        "Two Tales of the Iron Druid Chronicles (The Iron Druid Chronicles, #0.6, 3.5)",
        "Two Tales of the Iron Druid Chronicles",
        [Series(name="The Iron Druid Chronicles", numbers=["0.6", "3.5"])],
    ),
    (
        "The Great Bazaar and Other Stories (Demon Cycle, #1.6)",
        "The Great Bazaar and Other Stories",
        [Series(name="Demon Cycle", numbers=["1.6"])],
    ),
    ...
    (
        "Legend of the Arch Magus: Publisher's Pack 1 (Legend of the Arch Magus, #1-2)",
        "Legend of the Arch Magus: Publisher's Pack 1",
