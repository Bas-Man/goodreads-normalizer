...
CSV_DATA = """Book Id,Title,Author,Author l-f,Additional Authors,ISBN,ISBN13,My Rating,Publisher,Binding
226152904,"Crystal Core 3: Crystal Core, Book 3",David Burke,"Burke, David",,,"",0,Podium Audio,Audible Audio
226146301,"Crystal Core: Crystal Core, Book 1",David  Burke,"Burke, David",,,"",3,"",Kindle
"""
